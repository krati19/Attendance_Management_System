...
class Recognition:
    def __init__(self,root):
        ...
        # Recognition Button
        std_img_btn=Image.open(r"images\detect.png")
        ...
        std_b1_1 = Button(bg_img,command=self.face_recog,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="navyblue",fg="white")
...
#================face recognition==================================================================================
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            featuers=classifier.detectMultiScale(grey_image,scaleFactor,minNeighbors)
